    ...
    <section class="bg-white">
        ...
        <div class="container mx-auto flex items-start flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="producto hover:grow hover:shadow-lg" src="img/producto1.jpg">
                    <div class="pt-3 flex items-center justify-between">
                        <p class="font-bold">Product Name</p>
                        <p class="pt-1 text-green-900 font-bold">$9.99</p>
                    </div>
                    <p class="text-justify">Un pastelito chido con cubierta de chocolate y un kit de licores, preferido de los clientes.</p>
                </a>
