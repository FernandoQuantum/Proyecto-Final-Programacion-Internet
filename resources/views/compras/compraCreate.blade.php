...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <section class="flex justify-center p-6">
        ...
        <!-- <div class="w-full md:w-1/2 xl:w-1/4 p-6 flex justify-center">
            <img class="producto hover:grow hover:shadow-lg" src="/img/{{$producto->prod_picture}}">
            <div class="w-400 pt-3 flex flex-col items-center justify-between">
                    <h1>Resumen de compra</h1>
                    <p class="font-bold"><b>Producto:<b>{{$producto->name}}</p>
                    <p class="pt-1 text-green-900 font-bold"><b>Precio:</b> ${{$producto->price}}</p>
                    <p class="text-justify"><b>Descripción:</b> {{$producto->desc}}</p>
                    <p class=>Listo en {{$producto->hours}} hora(s).</p>
